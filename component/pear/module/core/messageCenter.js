layui.define(['table', 'jquery', 'element'], function (exports) {
	...
	function createHtml(option) {
		...
		var notice = '<li class="layui-nav-item" lay-unselect=""><a href="#" class="notice layui-icon layui-icon-notice"></a><div class="layui-nav-child layui-tab pear-notice" style="margin-top: 0px;left: -200px;padding:0px;">';
		noticeTitle += '</ul>';
		noticeContent += '</div>';
		notice += noticeTitle;
