layui.define(['table', 'jquery', 'element'], function (exports) {
	...
	function createMenuAndControl(option) {
		var control = '<div style="width: ' + option.controlWidth + 'px;white-space: nowrap;overflow-x: scroll;" class="control miniscrollbar"><ul class="layui-nav pear-nav-control pc layui-hide-xs" style="width: fit-content;">';
